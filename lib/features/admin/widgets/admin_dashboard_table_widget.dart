...
class AdminDashboardTableWidget extends StatefulWidget {
  const AdminDashboardTableWidget({
    super.key,
    required this.adminDashboardModel,
  });

  final List<AdminDashboardModel> adminDashboardModel;

  @override
  State<AdminDashboardTableWidget> createState() => _AdminDashboardTableWidgetState();
}

class _AdminDashboardTableWidgetState extends State<AdminDashboardTableWidget> {
  @override
